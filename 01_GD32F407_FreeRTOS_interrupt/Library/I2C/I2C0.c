...
int8_t I2C0_write2(uint8_t addr, uint8_t reg, uint8_t* data, uint16_t offset, uint32_t len){
...
void I2C0_init(){    
    ...
    i2c_clock_config(i2cx, I2C0_SPEED, I2C_DTCY_16_9);
